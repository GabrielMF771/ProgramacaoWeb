...
> *Dica: utilize a biblioteca Math para gerar os números aleatórios (opções que o computador pode escolher);*
...
**4 - Crie um programa que desenha um triângulo de asteriscos (*) no console, onde o número de linhas é especificado pelo usuário.**
...
**5 - Escreva um programa para encontrar a soma da série 1 + 11 + 111 + ... n termos. Conforme a entrada a seguir:**
